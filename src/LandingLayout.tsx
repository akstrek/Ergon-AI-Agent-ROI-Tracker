...
import { ArrowLeft, ArrowRight, Layout, BarChart3, Activity, User, ArrowUpRight } from 'lucide-react';
            ...
            <div className="absolute inset-0 rounded-[2rem] bg-gradient-to-br from-[#00E5FF]/80 via-white/10 to-transparent p-[1px] opacity-80 group-hover:opacity-100 transition-opacity duration-500 shadow-[0_0_20px_rgba(0,0,0,0.5)] group-hover:shadow-[0_20px_50px_rgba(0,229,255,0.15)]">
                ...
                <div className="w-full h-full rounded-[calc(2rem-1px)] bg-[rgba(5,5,5,0.7)] backdrop-blur-3xl relative overflow-hidden flex flex-col p-8 z-10">
                    ...
                    <div className="relative z-20 flex flex-col h-full w-full">
                        ...
                        {/* Float Graphic Container (Constraints Removed) */}
...
export default function LandingLayout({ setActiveTool }: { activeTool: string | null; setActiveTool: (id: string) => void }) {
  ...
  return (
    <div className="flex w-full h-[calc(100vh-100px)] mt-[100px] items-center pb-20 justify-between">
      {/* LEFT HEMISPHERE: Typography & Pagination */}
      ...
      {/* RIGHT HEMISPHERE: Spatial Carousel */}
